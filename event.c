...
Event createEvent(char* name, Date date, int event_id)
{
    ...
    event->Members = pqCreate(copyMemberPQElement, freeMemberElement, equalMemberElements, copyMemberPriority, freeMemberElementPriority, compareMemberElementPriorities);
    return event;
}
